...
const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.web.search.apiKey": "DuckDuckGo Search API Key (optional, defaults to none)",
...
const FIELD_HELP: Record<string, string> = {
  ...
  "tools.web.search.provider": 'Search provider ("duckduckgo" or "perplexity").',
  "tools.web.search.apiKey": "Search API key (optional; DuckDuckGo is free).",
