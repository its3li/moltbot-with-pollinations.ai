...
describe("web_search freshness normalization", () => {
  it("returns undefined for all values (disabled for DuckDuckGo)", () => {
    expect(normalizeFreshness("pd")).toBeUndefined();
    expect(normalizeFreshness("PW")).toBeUndefined();
    expect(normalizeFreshness("2024-01-01to2024-01-31")).toBeUndefined();
  });
});
